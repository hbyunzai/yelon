import{a as wi,b as Ge}from"./chunk-UMEBBSYE.js";import{d as Ke,e as Xe}from"./chunk-U447LIPJ.js";import{a as li}from"./chunk-WSTP2ODY.js";import{a as ge}from"./chunk-QDLDUTZF.js";import{a as Ci,b as bi}from"./chunk-IYLNTXJU.js";import"./chunk-RSQX3RUZ.js";import{a as qe,b as zi}from"./chunk-55PKHDRD.js";import{a as xi,b as hi}from"./chunk-MAJ3KOKM.js";import{a as vi,b as gi,c as yi}from"./chunk-T5YD2VZE.js";import{a as fi,d as _i,e as Je}from"./chunk-HECJHM36.js";import"./chunk-CMT3EP5V.js";import{a as Si}from"./chunk-YABJB64B.js";import"./chunk-MGRYIZTU.js";import{E as Ye,G as pi,I as Di,N as Ti,P as Z,d as ri,g as We,m as Qe,v as Ze,x as si,y as di}from"./chunk-QLAL4IGO.js";import{$h as mi,Ab as Ct,Ac as zt,Ad as ve,Bb as bt,Bc as te,Cb as ke,Cc as z,Da as me,Db as Ie,Dc as St,Dd as Ht,Dg as ii,Ed as Ve,Fa as fe,Gg as ni,Ha as xt,Hb as L,Hd as E,Hg as I,Ia as r,Ib as Dt,Ig as Ue,J as ze,Jb as T,Jc as ie,Je as Vt,Kb as _e,Kd as At,Lb as st,Lc as wt,Mb as t,Mc as Oe,Md as Re,Na as Ee,Nb as U,Ob as N,Pb as Tt,Pg as oe,Qa as h,Qb as $,Qc as Lt,Ra as Me,Rb as j,Rd as M,Re as Pe,Sb as W,Td as Be,Uf as Ut,Vf as $t,Vg as ae,Wa as g,Wh as ci,Xa as ht,Xb as dt,Xg as Q,Y as ue,Ya as Ne,Yg as re,Yh as ui,a as lt,ac as Fe,ah as oi,bc as k,bg as jt,cb as J,da as Se,dd as Et,ea as we,eb as y,fc as R,fg as Wt,g as ce,gb as x,gc as B,gd as He,ha as u,hb as O,hd as Mt,hf as Rt,hg as Qt,i as vt,id as pt,if as Bt,ig as Zt,jb as H,jd as Nt,jg as Yt,kb as A,kc as P,kd as kt,la as _,lb as p,ld as Ae,lf as Pt,m as gt,ma as v,mb as l,md as It,mg as Jt,n as G,nb as s,ng as qt,ob as m,pd as ne,pg as Gt,qa as K,qd as Ft,ra as Le,rb as V,rg as Kt,sb as b,sg as Xt,ug as ei,vb as f,vg as ti,wh as $e,xb as d,xd as Ot,ya as yt,yb as X,yh as ai,zb as ee,zh as je}from"./chunk-5WYQ2NZI.js";var et=class n{cookieSrv=u(Rt);msg=u(Z);key="test-key";value;constructor(){this.get()}get(){this.value=this.cookieSrv.get(this.key)}set(i){this.cookieSrv.put(this.key,(+new Date).toString(),i),this.msg.success("Success")}remove(){this.cookieSrv.remove(this.key)}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=h({type:n,selectors:[["app-demo"]],decls:16,vars:1,consts:[["classs","mb-md"],["nz-button","",3,"click"]],template:function(e,o){e&1&&(t(0,`
    `),l(1,"p",0),t(2),s(),t(3,`
...
`)),e&2&&(r(8),A(o.list))},dependencies:[ie,Ye,I,si],encapsulation:2,changeDetection:0})};ce([ge()],ye.prototype,"showSubMenu",1);var xe=ye;var ki=n=>({$implicit:n});function mn(n,i){n&1&&V(0)}function fn(n,i){if(n&1&&(t(0,`
  ...
  `)),e&2&&(r(),x(o.showFetching?1:-1),r(),x(!o.opt.hideHeader&&o.displayNav?2:-1),r(),x(!o.opt.hideAside&&o.displayAside?3:-1),r(),_e(o.contentStyle),r(2),p("ngTemplateOutlet",o.content))},dependencies:[ie,I,xe,Ce],encapsulation:2})};var Vn=["*"],De=class n{selected=!1;disabled=!1;static \u0275fac=function(e){return new(e||n)};static \u0275cmp=h({type:n,selectors:[["layout-default-top-menu-item"]],hostVars:8,hostBindings:function(e,o){e&2&&T("yunzai-default__nav-item",!0)("yunzai-default__top-menu-item",!0)("yunzai-default__top-menu-item-selected",o.selected)("yunzai-default__top-menu-item-disabled",o.disabled)},inputs:{selected:[2,"selected","selected",z],disabled:[2,"disabled","disabled",z]},standalone:!1,ngContentSelectors:Vn,decls:1,vars:0,template:function(e,o){e&1&&(X(),ee(0))},encapsulation:2,changeDetection:0})};var it=class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=Me({type:n});static \u0275inj=we({imports:[Lt,Ot,pi,Ue,Ge,Je,di]})};var nt=class n{srv=u(Y);static \u0275fac=function(e){return new(e||n)};static \u0275cmp=h({type:n,selectors:[["dev-home"]],decls:34,vars:4,consts:[[3,"autoBreadcrumb"],[1,"mb-md"],["nz-button","",3,"click"]],template:function(e,o){e&1&&(t(0,`
    ...
    `),s(),t(33,`
  `)),e&2&&(r(),p("autoBreadcrumb",!1),r(3),N(" options: ",B(5,2,o.srv.options)," "))},dependencies:[Oe,Xe,Ke,re,Q,oe,ae],encapsulation:2})};var _t=()=>({standalone:!0});function $n(n,i){if(n&1){let e=b();t(0,`
...
`)),e&2&&(p("nzVisible",o.collapse)("nzPlacement",o.dir()==="rtl"?"left":"right")("nzWidth",500),r(5),T("setting-drawer__handle-opened",o.collapse),p("nzTooltipTitle",o.isDev?o.devTips:null),r(2),p("nzType",o.collapse?"close":"setting"))},dependencies:[Ze,We,Qe,je,ai,$e,Ye,I,bi,Ci,yi,gi,vi,le,zi,qe,Q,Si],encapsulation:2,changeDetection:0})};ce([ge()],se.prototype,"loadLess",1),ce([ge()],se.prototype,"runLess",1);var de=se;var eo=[le,de],at=class n{static \u0275fac=function(e){return new(e||n)};static \u0275mod=Me({type:n});static \u0275inj=we({imports:[eo]})};function to(n,i){if(n&1){let e=b();t(0,`
  ...
  `)}if(e&2){let a=L(30);r(),p("options",o.options)("asideUser",a),r(12),A(o.topMenus),r(6),U(B(20,5,o.rtl.nextDir)),r(13),p("mode",2)("customContextMenu",o.customContextMenu)}},dependencies:[wt,it,be,q,De,Ue,I,Je,ui,ci,fi,_i,Ge,wi,mi,hi,It,at,de],encapsulation:2})};var w=class n{route=u(Ae);srv=u(xi);first=Pe(new Date,"yyyy-MM-dd HH:mm:ss");now=Pe(new Date,"yyyy-MM-dd HH:mm:ss");id=0;ngOnInit(){this.route.params.subscribe(i=>this.id=+i.id)}_onReuseInit(){this.now=Pe(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("by _onReuseInit",this.id)}replace(i){this.srv.replace(i)}static \u0275fac=function(e){return new(e||n)};static \u0275cmp=h({type:n,selectors:[["dev-page"]],decls:19,vars:12,consts:[["nz-button","","nzType","primary",3,"click"]],template:function(e,o){e&1&&(t(0,`
    `),m(1,"page-header"),t(2,`
  ...
  `)),e&2&&(r(4),Tt("first: ",B(5,4,o.first),"\uFF0Cnow: ",B(6,6,o.now)),r(5),N("id: ",B(10,8,o.id)),r(2),N(`
    ...
    `))},dependencies:[Xe,Ke,Oe,re,Q,oe,ae],encapsulation:2})};var jl=[{path:"demo",component:et},{path:"",component:rt,children:[{path:"home",component:nt},{path:"l1",component:w},{path:"l2",component:w},{path:"l3",component:w},{path:"l4",component:w},{path:"l5",component:w},{path:"l6",component:w},{path:"l7",component:w},{path:"l8",component:w},{path:"login",component:w},{path:"view/1",component:w,data:{reuseClosable:!1}},{path:"view/:id",component:w},{path:"lazy",loadChildren:()=>import("./chunk-5JI4SXMQ.js").then(n=>n.routes)},{path:"list",loadChildren:()=>import("./chunk-PRXLRESJ.js").then(n=>n.routes)}]}];export{jl as routes};
