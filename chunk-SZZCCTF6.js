import{f as M,g as w}from"./chunk-3MI7E427.js";import"./chunk-CBCFIN2R.js";import"./chunk-CCKEEZ5Y.js";import"./chunk-LLT56NTX.js";import"./chunk-GT7J47QU.js";import{Fb as e,Hb as y,Ib as f,Ka as d,Nb as h,Tb as i,Ub as o,Xc as I,Yc as x,dg as a,ea as u,jb as r,kb as p,lb as v,wa as c,wc as g}from"./chunk-4LVFALOC.js";var S=(()=>{let t=class t{constructor(){this.route=c(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=u({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
