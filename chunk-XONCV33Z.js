import{f as M,g as w}from"./chunk-MQ2AKJTM.js";import"./chunk-FCSXFWF2.js";import"./chunk-2KMHHGS6.js";import"./chunk-DQW7NPKP.js";import"./chunk-HIZYILBK.js";import{Db as e,Fb as y,Gb as f,Ka as d,Lb as h,Rb as i,Sb as o,Tc as I,Uc as x,ga as u,hb as r,ib as p,ja as c,jb as v,tc as g,xe as a}from"./chunk-MW3JJ3MN.js";var S=(()=>{let t=class t{constructor(){this.route=u(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=c({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
