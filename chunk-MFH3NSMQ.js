import{f as D,g as x}from"./chunk-2R6N5AD6.js";import"./chunk-FGHMPI7V.js";import"./chunk-K7LFTOH6.js";import"./chunk-JMOWTM5A.js";import"./chunk-JKJ3YCBR.js";import{Db as e,Fb as c,Gb as y,Ja as m,Lb as f,Rb as i,Sb as o,Vc as g,Wc as I,fa as l,ha as u,hb as r,ib as p,jb as v,te as a,uc as h}from"./chunk-2WZDLBTH.js";var L=(()=>{class t{constructor(){this.route=l(g),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}static{this.\u0275fac=function(n){return new(n||t)}}static{this.\u0275cmp=u({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[f],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
