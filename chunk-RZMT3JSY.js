...
}`,lang:"ts",componentName:"CacheServiceSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}];static \u0275fac=function(n){return new(n||c)};static \u0275cmp=l({type:c,selectors:[["app-cache-service"]],hostVars:2,hostBindings:function(n,i){n&2&&g("d-block","true")},decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,i){n&1&&(o(0,"app-docs",0)(1,"div",1)(2,"div",2),t(3,`
        `),o(4,"code-box",3),t(5,`
          `),v(6,"cache-service-simple"),t(7,`
        `),r(),t(8,`
