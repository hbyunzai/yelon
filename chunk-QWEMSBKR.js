import{f as M,g as w}from"./chunk-ZVX6ZZNX.js";import"./chunk-2ZGDYDWF.js";import"./chunk-KPYK4ZOV.js";import"./chunk-QOQPJMYA.js";import"./chunk-3H4FBNJS.js";import{Cb as e,Eb as y,Fb as f,Ia as d,Kb as h,Qb as i,Rb as o,Vc as I,Wc as x,fa as u,gb as r,ha as c,hb as p,ib as v,te as a,uc as g}from"./chunk-B5KC2RQS.js";var S=(()=>{let t=class t{constructor(){this.route=u(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=c({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
