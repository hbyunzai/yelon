import{Bg as k,Eb as e,Gb as s,Ja as r,Mb as u,Sb as f,Tb as v,Wa as l,da as c,ib as n,jb as i,mg as z,ng as y,pg as h,rb as p,rg as D,va as d,vc as x,wg as _}from"./chunk-ZKKUKXOF.js";var I=(()=>{let t=class t{constructor(){this.modal=d(_)}ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}};t.\u0275fac=function(o){return new(o||t)},t.\u0275cmp=c({type:t,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},standalone:!0,features:[u],decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"nzType","nzSize","click"]],template:function(o,m){o&1&&(e(0,`
    `),n(1,"div",0),e(2,`
