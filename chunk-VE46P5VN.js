import{a as te,b as ne}from"./chunk-3H4FBNJS.js";import{a as k,b as A,c as U,d as j,q as J,r as Q,s as W,y as ee}from"./chunk-TNQ3PHHZ.js";import{F as G,H,x as O,y as P}from"./chunk-QDTQCLSP.js";import{Cb as e,Db as u,Eg as B,Fg as $,Ia as a,Kb as T,Lb as L,Sa as _,Ua as h,Wa as v,Wc as V,Zc as w,_c as R,bb as s,bc as E,cb as D,eb as N,fa as d,fb as b,gb as i,ha as S,hb as o,ib as z,mb as g,nd as y,pb as C,pd as X,qa as x,ra as f,rb as c,sh as K,ub as I,uh as Y,vh as Z,xa as M,xh as q,za as F}from"./chunk-B5KC2RQS.js";var re=()=>["ant-menu-item-selected"];function ae(n,l){n&1&&(e(0,`
          ...
          `),i(1,"li",2),C("click",function(){let r=x(t).$implicit,p=c(2);return f(p.to.emit(r.url))}),e(2,`
            `),i(3,"nz-badge",3),e(4,`
              ...
              `),_(11,ae,4,1),o(),e(12,`
          `),o(),e(13,`
        `)}if(n&2){let t=l.$implicit;a(),v("menu-deprecated",t.deprecated),h("routerLink",t.url)("routerLinkActive",L(9,re))("nzTooltipTitle",t.deprecated?"Deprecated in "+t.deprecated:null),a(2),h("nzDot",t.hot),a(3),u(t.title),a(3),u(t.subtitle),a(2),s(t.lib?11:-1)}}function me(n,l){if(n&1&&(e(0,`
    `),i(1,"li",1),e(2,`
      `),i(3,"ul"),e(4,`
...
`)}if(n&2){let t=c();a(3),v("drawer-open",t.opened)}}var Ge=(()=>{let l=class l{constructor(){this.meta=d(k),this.mobileSrv=d(A),this.cdr=d(E),this.destroy$=d(M),this.opened=!1}ngOnInit(){this.mobileSrv.change.pipe(y(this.destroy$)).subscribe(m=>{this.isMobile=m,this.cdr.detectChanges()})}to(){this.opened=!1}};l.\u0275fac=function(r){return new(r||l)},l.\u0275cmp=S({type:l,selectors:[["app-content"]],hostVars:2,hostBindings:function(r,p){r&2&&v("main-wrapper",!0)},standalone:!0,features:[T],decls:16,vars:5,consts:[["nz-row",""],["nz-col","","nzXs","24","nzSm","24","nzMd","18","nzLg","18","nzXl","19","nzXXl","20"],[1,"main-container"],["small",""],["nz-col","","nzXs","24","nzSm","24","nzMd","6","nzLg","6","nzXl","5","nzXXl","4",1,"main-menu"],["main-menu","",1,"main-menu-inner",3,"to"],[1,"prev-next-nav"],[1,"prev-page",3,"routerLink"],["nz-icon","","nzType","left",1,"footer-nav-icon-before"],[1,"chinese"],[1,"next-page",3,"routerLink"],["nz-icon","","nzType","right",1,"footer-nav-icon-after"],[1,"drawer-wrapper"],[1,"drawer","drawer-left"],[1,"drawer-mask",3,"click"],[1,"drawer-content-wrapper"],[1,"drawer-content"],[3,"to"],[1,"drawer-button",3,"click"],["nz-icon","","nzType","menu-unfold"]],template:function(r,p){r&1&&(i(0,"div",0),e(1,`
  ...
  `),o(),e(13,`
`),o(),e(14,`
`),_(15,ue,20,2)),r&2&&(a(2),s(p.isMobile?-1:2),a(3),v("pages-container",p.meta.isPages),a(5),s(p.meta.next||p.meta.prev?10:-1),a(5),s(p.isMobile?15:-1))},dependencies:[V,w,ee,ne,te,$,B,ie,W,Q,J],encapsulation:2,changeDetection:0});let n=l;return n})();export{Ge as a};
