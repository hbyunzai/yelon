import{b as G,c as Q}from"./chunk-TGND4S5E.js";import{a as ie}from"./chunk-B5SQRTB2.js";import{F as X,H as ee,R as te}from"./chunk-P2SNGHCI.js";import{Cb as B,Db as e,Eb as k,Fb as z,Ga as N,H as j,Ia as v,Ka as r,La as h,Lb as q,Lc as Z,Nb as g,Ob as E,Rb as C,Sb as f,Se as J,Ta as u,Va as a,Vg as L,Wb as D,Wg as W,Xa as w,bc as P,cb as T,ed as A,ga as F,hb as c,ib as p,ja as O,jb as I,jc as R,ld as V,nb as b,nd as $,pc as U,qb as _,qe as Y,sa as m,sb as S,ta as x,tb as H,ub as K,za as M}from"./chunk-MW3JJ3MN.js";var oe=["*"],re=t=>({background:t}),ce=t=>({"browser-mockup":t}),pe=t=>({"height.px":t}),se=t=>({"browser-scroll":t}),ae=(t,s)=>({"code-expand-icon-hide":t,"code-expand-icon-show":s}),le=(t,s)=>({"code-expand-icon-show":t,"code-expand-icon-hide":s}),de=t=>({"highlight-wrapper-expand":t});function me(t,s){if(t&1&&(e(0,`
  ...
  `)),t&2){let l=S();r(2),z(`
      ...
      `),r(),a("item",l.item),r(3),a("innerHTML",l.item.summary,N)}}function xe(t,s){if(t&1){let l=b();e(0,`
        ...
        `),r(2),T(2,-1))}function he(t,s){if(t&1){let l=b();e(0,`
...
`),c(34,"section",11),e(35,`
  ...
  `),p(),e(42,`
`),p(),e(43,`
`)}if(o&2){let d=B(20);a("ngStyle",g(20,re,i.item.bg)),r(2),a("ngClass",g(22,ce,i.item.browser))("ngStyle",g(24,pe,i.item.browser)),r(2),a("ngClass",g(26,se,i.item.browser)),r(9),T(13,i.type==="default"?13:-1),r(3),T(16,-1),r(),a("nzTooltipTitle",d),r(5),w("ant-tooltip-open",i.copied),a("nzTooltipTitle",f(23,18,"app.demo.copy"))("nzType",i.copied?"check":"snippets"),r(3),a("nzTooltipTitle",i.expand?"Hide Code":"Show Code"),r(2),a("src",i.theme==="dark"?"https://gw.alipayobjects.com/zos/antfincdn/btT3qDZn1U/wSAkBuJFbdxsosKKpqyq.svg":"https://gw.alipayobjects.com/zos/rmsportal/wSAkBuJFbdxsosKKpqyq.svg",v)("ngClass",E(28,ae,i.expand,!i.expand)),r(2),a("src",i.theme==="dark"?"https://gw.alipayobjects.com/zos/antfincdn/CjZPwcKUG3/OpROPHYqWmrMDBFMZtKF.svg":"https://gw.alipayobjects.com/zos/rmsportal/OpROPHYqWmrMDBFMZtKF.svg",v)("ngClass",E(31,le,i.expand,!i.expand)),r(5),a("ngClass",g(34,de,i.expand)),r(6),k(i.item.code)}},dependencies:[U,R,J,ee,X,W,L,ie],encapsulation:2,changeDetection:0});let t=s;return t})();export{Ne as a};
