 ...
 *   `ng g ng-yunzai:tpl swagger-list list -m=trade -t=trade --swaggerPath=/pet/findByStatus`
 * - Generation edit by swagger api:
 *   `ng g ng-yunzai:tpl swagger-edit edit -m=trade -t=trade --swaggerPath=/pet --swaggerMethod=post`
 */

const sts = require('ng-yunzai-sts/src/generator');
const cog = {
