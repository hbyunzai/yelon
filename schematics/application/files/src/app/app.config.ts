...
import { authSimpleInterceptor, provideAuth } from '@yelon/auth';<% if (form) { %>
...
const providers: Array<Provider | EnvironmentProviders> = [
  ...
  provideYunzai({ config: yunzaiConfig, defaultLang<% if (i18n) { %>, i18nClass: I18NService<% } %>, icons: [...ICONS_AUTO, ...ICONS] }),
