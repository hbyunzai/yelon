...
describe('Schematic: empty', () => {
  ...
  describe('[with module]', () => {
    ...
    describe('', () => {
      beforeEach(async () => {
        ({ runner, tree } = await createYunzaiAndModuleApp({ moduleSchema: { standalone: false } }));
      });
  ...
  describe('[with standalone]', () => {
    ...
    describe('', () => {
      beforeEach(async () => {
        ({ runner, tree } = await createYunzaiAndModuleApp({ moduleSchema: { standalone: true } }));
      });
