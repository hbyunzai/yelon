import{f as D,g as x}from"./chunk-BFIGUBHJ.js";import"./chunk-IO7AUPGW.js";import"./chunk-NBUX6NTQ.js";import"./chunk-4C3AF3HS.js";import"./chunk-4TH24IY7.js";import{Db as e,Fb as c,Gb as y,Ja as m,Lb as f,Rb as i,Sb as o,Vc as g,Wc as I,fa as l,ha as u,hb as r,ib as p,jb as v,te as a,uc as h}from"./chunk-5G6CWZQB.js";var L=(()=>{class t{constructor(){this.route=l(g),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}static{this.\u0275fac=function(n){return new(n||t)}}static{this.\u0275cmp=u({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[f],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
