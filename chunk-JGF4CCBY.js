import{Bg as x,Db as e,Fb as d,Hg as z,Ja as r,Jg as D,Lb as s,Lg as y,Og as h,Rb as u,Sb as f,Va as m,bh as S,fa as p,ha as c,hb as t,ib as n,qb as l,uc as v}from"./chunk-2WZDLBTH.js";var j=(()=>{class i{constructor(){this.modal=p(h)}ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static{this.\u0275fac=function(o){return new(o||i)}}static{this.\u0275cmp=c({type:i,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},standalone:!0,features:[s],decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(o,a){o&1&&(e(0,`
    `),t(1,"div",0),e(2,`
