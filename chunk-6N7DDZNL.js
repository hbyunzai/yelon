import{$g as y,Fb as m,Jc as u,Ma as o,Vb as e,Xa as c,Xb as d,fh as z,ha as l,hh as v,ib as a,jc as s,jh as D,kc as f,kh as _,wb as t,xb as n,zh as N}from"./chunk-5RQNGF3E.js";var S=class p{modal=l(_);record;ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(i){return new(i||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(i,r){i&1&&(e(0,`
    `),t(1,"div",0),e(2,`
