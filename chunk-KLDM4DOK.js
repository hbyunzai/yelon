import{Ch as S,Dc as g,Ia as i,Qa as c,Rb as e,Rc as f,Tb as l,Ug as v,_g as _,ah as y,bh as z,ha as d,kc as s,lc as u,mb as a,nb as t,nh as N,ob as n,yc as C,zb as m}from"./chunk-C5ENAQHW.js";var h=class p{modal=d(N);record;input_value=C("");model_value=g("");ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(o){return new(o||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record",input_value:[1,"input_value"],model_value:[1,"model_value"]},outputs:{model_value:"model_valueChange"},decls:26,vars:9,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(o,r){o&1&&(e(0,`
    `),t(1,"div",0),e(2,`
