export const ENUS = {
  ...
  'app.home.feature.yelon': 'A set of higher-order components, chart, authentication, ACL, cache, mock, testing, etc.',
  ...
  'app.home.feature.tool.desc': 'NG-YUNZAI Schematics',
  ...
  'app.header.menu.yelon': 'Yelon Library',
  'app.header.menu.auth': '@yelon/auth-Authentication',
  'app.header.menu.acl': '@yelon/acl-Access Control List',
  'app.header.menu.cache': '@yelon/cache-Cache',
  'app.header.menu.chart': '@yelon/chart-Chart',
  'app.header.menu.mock': '@yelon/mock-Mock',
  'app.header.menu.util': '@yelon/util-Utils',
  'app.header.menu.form': '@yelon/form-Dynamic Form',
  'app.header.menu.theme': '@yelon/theme-Theme System',
  'app.header.menu.bis': '@yelon/bis-Yunzai Business',
