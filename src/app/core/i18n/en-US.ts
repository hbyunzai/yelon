export const ENUS = {
  ...
  'app.home.feature.tool.desc': 'Includes NG-YUNZAI Schematics, VSCODE extension',
  ...
  'app.header.menu.auth': 'Authentication',
  'app.header.menu.acl': 'Access Control List',
  'app.header.menu.cache': 'Cache',
  'app.header.menu.chart': 'Chart',
  'app.header.menu.mock': 'Mock',
  'app.header.menu.util': 'Utils',
  'app.header.menu.form': 'Dynamic Form',
  'app.header.menu.theme': 'Theme System',
  'app.header.menu.form.validator': 'Online Validator',
  'app.header.menu.bis': 'Bis',
  'app.header.menu.bcs': 'Bcs',
  'app.header.menu.socket': 'Socket',
