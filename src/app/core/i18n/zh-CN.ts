export const ZHCN = {
  ...
  'app.header.search': '在 ng-yunzai.com 中搜索',
  'app.home.preview': '预览',
  'app.home.start': '开始使用',
  ...
  'app.home.feature.yelon': '一组更高阶的业务组件、图表、认证、授权、缓存、Mock、测试等',
  ...
  'app.header.menu.yelon': 'Yelon库',
  'app.header.menu.auth': '@yelon/auth-用户认证',
  'app.header.menu.acl': '@yelon/acl-访问控制列表',
  'app.header.menu.cache': '@yelon/cache-缓存',
  'app.header.menu.chart': '@yelon/chart-图表',
  'app.header.menu.mock': '@yelon/mock-Mock模拟数据',
