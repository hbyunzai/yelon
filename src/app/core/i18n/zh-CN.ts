export const ZHCN = {
  ...
  'app.home.feature.tool.desc': '包含 NG-YUNZAI Schematics 、VSCODE插件',
  ...
  'app.header.menu.auth': '用户认证',
  'app.header.menu.acl': '访问控制列表',
  'app.header.menu.cache': '缓存',
  'app.header.menu.chart': '图表',
