import{a as G}from"./chunk-ZDRUCMRS.js";import"./chunk-VEQAM7ID.js";import{a as M}from"./chunk-OBSOWHEG.js";import{a as Z}from"./chunk-JTNMGYQ5.js";import"./chunk-QK4LM2I6.js";import"./chunk-4TH24IY7.js";import"./chunk-7EF2AH5B.js";import{q as B,r as w,s as D}from"./chunk-LGZLE6KP.js";import{R as T}from"./chunk-YVNN56XS.js";import{Bg as _,Cc as Y,Db as t,Fb as C,Hg as x,Ic as L,Ja as l,Jg as z,Ka as u,Lb as p,Lg as E,Rb as S,Sb as k,Ua as v,Va as d,Xa as g,Y as P,a as O,ba as A,da as W,fa as h,fd as Q,ha as m,hb as o,ib as r,j,jb as b,l as J,ld as q,qb as a,qe as X,s as H,sd as R,uc as N,w as K}from"./chunk-5G6CWZQB.js";var ee=new W("DC_STORE_STORAGE_TOKEN",{providedIn:"root",factory:()=>new U}),U=class{constructor(){this.platform=h(R)}get(I){return this.platform.isBrowser&&JSON.parse(localStorage.getItem(I)||"null")||null}set(I,e){return this.platform.isBrowser&&localStorage.setItem(I,JSON.stringify(e)),!0}remove(I){this.platform.isBrowser&&localStorage.removeItem(I)}};var f=(()=>{class s{constructor(){this.store=h(ee),this.http=h(L),this.platform=h(R),this.memory=new Map,this.notifyBuffer=new Map,this.meta=new Set,this.freqTick=3e3,this.cog=h(q).merge("cache",{mode:"promise",reName:"",prefix:"",meta_key:"__cache_meta"}),this.platform.isBrowser&&(this.loadMeta(),this.startExpireNotify())}pushMeta(e){this.meta.has(e)||(this.meta.add(e),this.saveMeta())}removeMeta(e){this.meta.has(e)&&(this.meta.delete(e),this.saveMeta())}loadMeta(){let e=this.store.get(this.cog.meta_key);e&&e.v&&e.v.forEach(n=>this.meta.add(n))}saveMeta(){let e=[];this.meta.forEach(n=>e.push(n)),this.store.set(this.cog.meta_key,{v:e,e:0})}getMeta(){return this.meta}set(e,n,i={}){if(!this.platform.isBrowser)return;let c=0,{type:y,expire:pe}=this.cog;i=O({type:y,expire:pe},i),i.expire&&(c=X(new Date,i.expire).valueOf());let F=i.emitNotify!==!1;if(!(n instanceof j)){this.save(i.type,e,{v:n,e:c},F);return}return n.pipe(P(ue=>{this.save(i.type,e,{v:ue,e:c},F)}))}save(e,n,i,c=!0){e==="m"?this.memory.set(n,i):(this.store.set(this.cog.prefix+n,i),this.pushMeta(n)),c&&this.runNotify(n,"set")}get(e,n={}){if(!this.platform.isBrowser)return null;let i=n.mode!=="none"&&this.cog.mode==="promise",c=this.memory.has(e)?this.memory.get(e):this.store.get(this.cog.prefix+e);return!c||c.e&&c.e>0&&c.e<new Date().valueOf()?i?(this.cog.request?this.cog.request(e):this.http.get(e)).pipe(K(y=>Q(y,this.cog.reName,y)),P(y=>this.set(e,y,{type:n.type,expire:n.expire,emitNotify:n.emitNotify}))):null:i?H(c.v):c.v}getNone(e){return this.get(e,{mode:"none"})}tryGet(e,n,i={}){if(!this.platform.isBrowser)return null;let c=this.getNone(e);return c===null?n instanceof j?this.set(e,n,i):(this.set(e,n,i),n):H(c)}has(e){return this.memory.has(e)||this.meta.has(e)}_remove(e,n){if(n&&this.runNotify(e,"remove"),this.memory.has(e)){this.memory.delete(e);return}this.store.remove(this.cog.prefix+e),this.removeMeta(e)}remove(e){this.platform.isBrowser&&this._remove(e,!0)}clear(){this.platform.isBrowser&&(this.notifyBuffer.forEach((e,n)=>this.runNotify(n,"remove")),this.memory.clear(),this.meta.forEach(e=>this.store.remove(this.cog.prefix+e)))}set freq(e){this.freqTick=Math.max(20,e),this.abortExpireNotify(),this.startExpireNotify()}startExpireNotify(){this.checkExpireNotify(),this.runExpireNotify()}runExpireNotify(){this.freqTime=setTimeout(()=>{this.checkExpireNotify(),this.runExpireNotify()},this.freqTick)}checkExpireNotify(){let e=[];this.notifyBuffer.forEach((n,i)=>{this.has(i)&&this.getNone(i)===null&&e.push(i)}),e.forEach(n=>{this.runNotify(n,"expire"),this._remove(n,!1)})}abortExpireNotify(){clearTimeout(this.freqTime)}runNotify(e,n){this.notifyBuffer.has(e)&&this.notifyBuffer.get(e).next({type:n,value:this.getNone(e)})}notify(e){if(!this.notifyBuffer.has(e)){let n=new J(this.getNone(e));this.notifyBuffer.set(e,n)}return this.notifyBuffer.get(e).asObservable()}cancelNotify(e){this.notifyBuffer.has(e)&&(this.notifyBuffer.get(e).unsubscribe(),this.notifyBuffer.delete(e))}hasNotify(e){return this.notifyBuffer.has(e)}clearNotify(){this.notifyBuffer.forEach(e=>e.unsubscribe()),this.notifyBuffer.clear()}ngOnDestroy(){this.memory.clear(),this.abortExpireNotify(),this.clearNotify()}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275prov=A({token:s,factory:s.\u0275fac,providedIn:"root"})}}return s})();var he=new Y(()=>({}));var re=(()=>{class s{get newValue(){return+new Date}constructor(e,n){this.srv=e,this.msg=n,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static{this.\u0275fac=function(n){return new(n||s)(u(f),u(T))}}static{this.\u0275cmp=m({type:s,selectors:[["cache-getting-started-simple"]],standalone:!0,features:[p],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(n,i){n&1&&(t(0,`
    `),o(1,"p"),t(2),S(3,"json"),r(),t(4,`
    `),o(5,"div",0),t(6,`
      Basic:
    ...
    `),r(),t(34,`
  `)),n&2&&(l(2),C("value: ",k(3,1,i.value),""))},dependencies:[N,E,z,_,x],encapsulation:2})}}return s})();var ce=(()=>{class s{constructor(){this.item={cols:1,urls:{"zh-CN":"packages/cache/docs/getting-started.md"},content:{"zh-CN":{content:`<section class="markdown"><h2 id="\u5199\u5728\u524D\u9762"><a class="lake-link"><i data-anchor="\u5199\u5728\u524D\u9762"></i></a>\u5199\u5728\u524D\u9762</h2><p>\u901A\u5E38\u628A\u4E00\u4E9B\u8FDC\u7A0B\u6570\u636E\u7F13\u5B58\u5728\u5185\u5B58\u6216 <code>localStorage</code> \u6301\u4E45\u5316\uFF0C\u76EE\u7684\u662F\u4E3A\u4E86\u51CF\u5C11 Http \u8BF7\u6C42\u7684\u6210\u672C\uFF1B\u8FD9\u6837\u7684\u6570\u636E\u901A\u5E38\u662F\u5B57\u5178\u3001\u57CE\u5E02\u6570\u636E\u7B49\u3002</p><p>\u7F13\u5B58\u7684\u83B7\u53D6\u5E94\u8BE5\u662F\u975E\u5E38\u7B80\u5355\u7684\uFF0C\u6211\u4EEC\u4E0D\u5E94\u8BE5\u628A\u65F6\u95F4\u6D6A\u8D39\u5728\u5982\u4F55\u4FDD\u8BC1\u52A0\u8F7D\u8FD9\u4EF6\u4E8B\u60C5\u4E0A\uFF0C\u56E0\u6B64 <code>@yelon/cache</code> \u66F4\u591A\u662F\u4EE5<strong>\u7EA6\u5B9A</strong>\u4E3A\u524D\u63D0\u3002<code>key</code> \u4F5C\u4E3A\u7F13\u5B58\u7684\u552F\u4E00\u952E\u503C\uFF0C\u5B83\u4E0D\u5E94\u8BE5\u53EA\u662F\u5355\u7EAF\u7684\u4E00\u4E2A\u6807\u8BC6\u7B26\uFF0C\u5982\u679C\u9075\u5B88\u67D0\u79CD\u7EA6\u5B9A\u5B83\u7684\u5B58\u5728\u4F1A\u66F4\u6709\u4EF7\u503C\u3002<code>@yelon/cache</code> \u9ED8\u8BA4\u60C5\u51B5\u4E0B\u4E0D\u5149\u628A <code>key</code> \u5F53\u4F5C\u552F\u4E00\u6807\u8BC6\u7B26\uFF0C\u540C\u65F6\u5B83\u8FD8\u662F\u4E00\u4E2A\u7528\u4E8E\u83B7\u53D6\u8FDC\u7A0B\u6570\u636E\u7684\u6709\u6548HTTP\uFF0C\u4F8B\u5982\uFF1A</p><pre class="hljs language-ts"><code>cacheService.get('/data/unit');</code></pre><p>\u5728\u4EE5\u5F80\u6211\u4EEC\u4F1A\u8BA4\u4E3A\uFF0C\u5728\u5B83\u4E4B\u524D\u5E94\u8BE5\u9700\u8981\u52A0\u4E00\u4E2A\uFF1A</p><pre class="hljs language-ts"><code>cacheService.set('/data/unit', [ '\u4E2A', '\u4EF6' ]);</code></pre><p>\u624D\u80FD\u591F\u786E\u4FDD\u83B7\u53D6\u5230\u7F13\u5B58\u6570\u636E\u3002</p><p>\u800C\u5BF9\u4E8E <code>@yelon/cache</code> \u800C\u8A00\uFF0C\u4F60\u65E0\u987B <code>set</code> \u65B9\u6CD5\uFF0C\u76F4\u63A5\u4F7F\u7528 <code>get</code> \u83B7\u53D6\u5230\u5355\u4F4D\u5B57\u5178\uFF0C\u56E0\u4E3A\u6211\u4EEC\u6709\u4E00\u79CD<strong>\u7EA6\u5B9A</strong>\uFF0C\u5F53\u7F13\u5B58\u4E0D\u5B58\u5728\u900F\u8FC7 <code>key</code> \u4F5C\u4E3AHTTP\u8BF7\u6C42\u6570\u636E\u7F13\u5B58\u540E\u518D\u8FD4\u56DE\u3002</p><p>\u7F13\u5B58\u7684\u83B7\u53D6\u4E0E\u8BBE\u7F6E\u90FD\u662F\u901A\u8FC7 <a href="/cache/service" data-url="/cache/service">CacheService</a> \u6765\u64CD\u4F5C\uFF0C\u4F60\u53EA\u9700\u8981\u5C06 <code>CacheService</code> \u5BFC\u5165\u5BF9\u5E94\u7684\u7C7B\u5F53\u4E2D\u5373\u53EF\u3002</p><h2 id="\u5982\u4F55\u4F7F\u7528"><a class="lake-link"><i data-anchor="\u5982\u4F55\u4F7F\u7528"></i></a>\u5982\u4F55\u4F7F\u7528</h2><p><strong>\u5B89\u88C5</strong></p><pre class="hljs language-bash"><code>npm i -S @yelon/cache</code></pre><h3 id="\u53C2\u6570"><a class="lake-link"><i data-anchor="\u53C2\u6570"></i></a>\u53C2\u6570</h3><table><thead><tr><th>\u6210\u5458</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u9ED8\u8BA4\u503C</th><th>\u5168\u5C40\u914D\u7F6E</th></tr></thead><tbody><tr><td><code>[mode]</code></td><td><code>promise,none</code></td><td><code>promise</code></td><td>\u7F13\u5B58\u6A21\u5F0F\uFF1B<code>promise</code> \u7EA6\u5B9A\u6A21\u5F0F\uFF0C\u5141\u8BB8 <code>key</code> \u4F5C\u4E3A http \u83B7\u53D6\u6570\u636E\uFF1B<code>none</code> \u6B63\u5E38\u6A21\u5F0F</td><td>\u2705</td></tr><tr><td><code>[reName]</code></td><td><code>string</code></td><td>-</td><td>\u91CD\u547D\u540D\u8FD4\u56DE\u53C2\u6570\uFF0C\u4F8B\u5982\uFF1A<br> <code>null</code> \u8FD4\u56DE\u4F53\u4E3A\u5185\u5BB9<br><code>list</code> \u8FD4\u56DE\u4F53\u5E94 <code>{ list: [] }</code><br><code>result.list</code> \u8FD4\u56DE\u4F53\u5E94 <code>{ result: { list: [] } }</code></td><td>\u2705</td></tr><tr><td><code>[expire]</code></td><td><code>number</code></td><td>-</td><td>\u8BBE\u7F6E\u9ED8\u8BA4\u8FC7\u671F\u65F6\u95F4\u503C\uFF08\u5355\u4F4D\uFF1A\u79D2\uFF09</td><td>\u2705</td></tr><tr><td><code>[prefix]</code></td><td><code>string</code></td><td>-</td><td>\u6301\u4E45\u5316\u6570\u636E\u952E\u503C\u524D\u7F00</td><td>\u2705</td></tr><tr><td><code>[meta_key]</code></td><td><code>string</code></td><td><code>__cache_meta</code></td><td>\u6301\u4E45\u5316\u6570\u636E\u5143\u6570\u636E\u5B58\u50A8\u952E\u540D</td><td>\u2705</td></tr><tr><td><code>[request]</code></td><td><code>(key: string) => Observable&lt;unknown></code></td><td>-</td><td>\u81EA\u5B9A\u4E49\u8BF7\u6C42\u4F53</td><td>\u2705</td></tr></tbody></table><blockquote><p>\u53EF\u4EE5\u901A\u8FC7<a href="/docs/global-config" data-url="/docs/global-config">\u5168\u5C40\u914D\u7F6E</a>\u8986\u76D6\u5B83\u4EEC\u3002</p></blockquote></section>`,meta:{order:1,title:"\u5F00\u59CB\u4F7F\u7528",type:"Documents"},toc:[{id:"\u5199\u5728\u524D\u9762",title:"\u5199\u5728\u524D\u9762",h:2},{id:"\u5982\u4F55\u4F7F\u7528",title:"\u5982\u4F55\u4F7F\u7528",h:2,children:[{id:"\u53C2\u6570",title:"\u53C2\u6570",h:3}]}]}},demo:!0},this.codes=[{id:"cache-getting-started-simple",meta:{title:{"zh-CN":"\u57FA\u7840\u6837\u4F8B","en-US":"Basic Usage"},order:0},summary:{"zh-CN":"<p>\u6700\u7B80\u5355\u7684\u7528\u6CD5\u3002</p>","en-US":"<p>Simplest of usage.</p>"},code:`import { JsonPipe } from '@angular/common';
...
}`,lang:"ts",componentName:"CacheGettingStartedSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=m({type:s,selectors:[["app-cache-getting-started"]],hostVars:2,hostBindings:function(n,i){n&2&&g("d-block","true")},standalone:!0,features:[p],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,i){n&1&&(o(0,"app-docs",0)(1,"div",1)(2,"div",2),t(3,`
        `),o(4,"code-box",3),t(5,`
          `),b(6,"cache-getting-started-simple"),t(7,`
        `),r(),t(8,`
      `),r()()()),n&2&&(d("codes",i.codes)("item",i.item),l(),d("nzGutter",16),l(3),d("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[M,G,re,D,w,B],encapsulation:2})}}return s})();var ae=(()=>{class s{get newValue(){return+new Date}constructor(e,n){this.srv=e,this.msg=n,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static{this.\u0275fac=function(n){return new(n||s)(u(f),u(T))}}static{this.\u0275cmp=m({type:s,selectors:[["cache-interceptor-simple"]],standalone:!0,features:[p],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(n,i){n&1&&(t(0,`
    `),o(1,"p"),t(2),S(3,"json"),r(),t(4,`
    `),o(5,"div",0),t(6,`
      Basic:
      `),o(7,"button",1),a("click",function(){return i.srv.set(i.key,i.newValue)}),t(8,"Set"),r(),t(9,`
...
}`,lang:"ts",componentName:"CacheInterceptorSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=m({type:s,selectors:[["app-cache-interceptor"]],hostVars:2,hostBindings:function(n,i){n&2&&g("d-block","true")},standalone:!0,features:[p],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,i){n&1&&(o(0,"app-docs",0)(1,"div",1)(2,"div",2),t(3,`
        `),o(4,"code-box",3),t(5,`
          `),b(6,"cache-interceptor-simple"),t(7,`
        `),r(),t(8,`
      `),r()()()),n&2&&(d("codes",i.codes)("item",i.item),l(),d("nzGutter",16),l(3),d("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[M,G,ae,D,w,B],encapsulation:2})}}return s})();var me=(()=>{class s{get newValue(){return+new Date}constructor(e,n){this.srv=e,this.msg=n,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}static{this.\u0275fac=function(n){return new(n||s)(u(f),u(T))}}static{this.\u0275cmp=m({type:s,selectors:[["cache-service-simple"]],standalone:!0,features:[p],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(n,i){n&1&&(t(0,`
    `),o(1,"p"),t(2),S(3,"json"),r(),t(4,`
    `),o(5,"div",0),t(6,`
      Basic:
      `),o(7,"button",1),a("click",function(){return i.srv.set(i.key,i.newValue)}),t(8,"Set"),r(),t(9,`
...
}`,lang:"ts",componentName:"CacheServiceSimpleComponent",point:0,name:"simple",urls:"packages/cache/docs/demo/simple.md",type:"demo"}]}static{this.\u0275fac=function(n){return new(n||s)}}static{this.\u0275cmp=m({type:s,selectors:[["app-cache-service"]],hostVars:2,hostBindings:function(n,i){n&2&&g("d-block","true")},standalone:!0,features:[p],decls:9,vars:5,consts:[[3,"codes","item"],["nz-row","",3,"nzGutter"],["nz-col","","nzSpan","24"],[3,"item"]],template:function(n,i){n&1&&(o(0,"app-docs",0)(1,"div",1)(2,"div",2),t(3,`
        `),o(4,"code-box",3),t(5,`
          `),b(6,"cache-service-simple"),t(7,`
        `),r(),t(8,`
      `),r()()()),n&2&&(d("codes",i.codes)("item",i.item),l(),d("nzGutter",16),l(3),d("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[M,G,me,D,w,B],encapsulation:2})}}return s})();var ut=[{path:"",component:Z,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:ce},{path:"interceptor",redirectTo:"interceptor/zh",pathMatch:"full"},{path:"interceptor/:lang",component:le},{path:"service",redirectTo:"service/zh",pathMatch:"full"},{path:"service/:lang",component:de}]}];export{ut as routes};
