...
export const environment = {
  ...
  '/data/(.*)': null
};</code></pre><h2 id="Value"><a class="lake-link"><i data-anchor="Value"></i></a>Value</h2><p>Supports three types: <code>Object</code>, <code>Array</code>, <code>(req: MockRequest) => any | Observable&lt;any> | Promise<any></code>.</p><pre class="hljs language-ts"><code>import { MockStatusError } from '@yelon/mock';
...
export const USERS = {
  ...
  // \u6B63\u5219\u8868\u8FBE\u5F0F\u9700\u8981\u7528 \`()\` \u5305\u88F9
  '/data/(.*)': null
};</code></pre><h2 id="Value\u54CD\u5E94\u5185\u5BB9"><a class="lake-link"><i data-anchor="Value\u54CD\u5E94\u5185\u5BB9"></i></a>Value\u54CD\u5E94\u5185\u5BB9</h2><p>\u54CD\u5E94\u5185\u5BB9\u652F\u6301\u4E09\u79CD\u7C7B\u578B\uFF1A<code>Object</code>\u3001<code>Array</code>\u3001<code>(req: MockRequest) => any | Observable&lt;any> | Promise<any></code>\u3002</p><pre class="hljs language-ts"><code>import { MockStatusError } from '@yelon/mock';
...
};</code></pre><h2 id="\u5B58\u50A8\u89C4\u5219"><a class="lake-link"><i data-anchor="\u5B58\u50A8\u89C4\u5219"></i></a>\u5B58\u50A8\u89C4\u5219</h2><p>\u4E00\u822C\u6765\u8BF4 Mock \u90FD\u662F\u5F00\u53D1\u8FC7\u7A0B\u4E2D\u9700\u8981\uFF0C\u56E0\u6B64\u5EFA\u8BAE\u5728\u9879\u76EE\u6839\u76EE\u5F55\u4E0B\u521B\u5EFA\u4E00\u4E2A <code>_mock</code> \u76EE\u5F55\uFF0C\u5E76\u521B\u5EFA\u4E00\u4E2A <code>index.ts</code> \u6587\u4EF6\u7528\u4E8E\u5BFC\u51FA\u6240\u6709\u6570\u636E\u89C4\u5219\uFF0C\u53C2\u8003 <a target="_blank" href="https://github.com/hbyunzai/ng-yunzai/tree/master/_mock" data-url="https://github.com/hbyunzai/ng-yunzai/tree/master/_mock">ng-yunzai/_mock</a>\u3002</p></section>`,meta:{order:2,title:"\u89C4\u5219\u6570\u636E",type:"Documents"},toc:[{id:"\u5199\u5728\u524D\u9762",title:"\u5199\u5728\u524D\u9762",h:2},{id:"Key\u8BF7\u6C42\u57DF\u58F0\u660E",title:"Key \u8BF7\u6C42\u57DF\u58F0\u660E",h:2},{id:"Value\u54CD\u5E94\u5185\u5BB9",title:"Value \u54CD\u5E94\u5185\u5BB9",h:2,children:[{id:"MockRequest",title:"MockRequest",h:3},{id:"MockStatusError",title:"MockStatusError",h:3}]},{id:"\u4E00\u4E9B\u793A\u4F8B",title:"\u4E00\u4E9B\u793A\u4F8B",h:2},{id:"\u5B58\u50A8\u89C4\u5219",title:"\u5B58\u50A8\u89C4\u5219",h:2}]}},demo:!1};codes=[];static \u0275fac=function(e){return new(e||o)};static \u0275cmp=a({type:o,selectors:[["app-mock-rule"]],hostVars:2,hostBindings:function(e,t){e&2&&r("d-block","true")},decls:1,vars:2,consts:[[3,"codes","item"]],template:function(e,t){e&1&&c(0,"app-docs",0),e&2&&n("codes",t.codes)("item",t.item)},dependencies:[s],encapsulation:2})};var S=[{path:"",component:p,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:i},{path:"rule",redirectTo:"rule/zh",pathMatch:"full"},{path:"rule/:lang",component:l}]}];export{S as routes};
