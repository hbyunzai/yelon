import{f as M,g as w}from"./chunk-ZOWQP7RW.js";import"./chunk-24UGX6Q3.js";import"./chunk-7T7S7JLS.js";import"./chunk-T6APYXIQ.js";import"./chunk-PVPZHL3I.js";import{Db as e,Fb as y,Gb as f,Ja as d,Lb as h,Rb as i,Sb as o,Yc as I,Zc as x,fa as u,ha as c,hb as r,ib as p,jb as v,we as a,xc as g}from"./chunk-FLGCG6NR.js";var S=(()=>{let t=class t{constructor(){this.route=u(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=c({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
