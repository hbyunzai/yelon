import{Dh as N,Fb as m,Jc as u,Ma as o,Vb as e,Xb as d,Za as c,bh as y,ga as l,hh as z,ib as a,jc as s,jh as v,kc as f,lh as D,oh as _,wb as t,xb as n}from"./chunk-237D6QE4.js";var S=class p{modal=l(_);record;ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(i){return new(i||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record"},decls:20,vars:7,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(i,r){i&1&&(e(0,`
    `),t(1,"div",0),e(2,`
