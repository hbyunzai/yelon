import{f as M,g as w}from"./chunk-SGGGORTZ.js";import"./chunk-W2AT2JQA.js";import"./chunk-EVG7HXZB.js";import"./chunk-EVQG4G2F.js";import"./chunk-6SLVSOHW.js";import{Eb as e,Gb as y,Hb as f,Ja as d,Mb as h,Sb as i,Tb as o,Wc as I,Xc as x,da as u,ib as r,jb as p,kb as v,te as a,va as c,vc as g}from"./chunk-HQY7S7TU.js";var S=(()=>{let t=class t{constructor(){this.route=c(I),this.first=a(new Date,"yyyy-MM-dd HH:mm:ss"),this.now=a(new Date,"yyyy-MM-dd HH:mm:ss")}ngOnInit(){console.log("LAYOUT LIST: ngOnInit")}_onReuseInit(){this.now=a(new Date,"yyyy-MM-dd HH:mm:ss"),console.log("LAYOUT LIST: by _onReuseInit",this.route.snapshot.url.toString())}ngOnDestroy(){console.log("LAYOUT LIST: ngOnDestroy")}};t.\u0275fac=function(n){return new(n||t)},t.\u0275cmp=u({type:t,selectors:[["dev-list-layout"]],standalone:!0,features:[h],decls:18,vars:6,consts:[[1,"px-lg"]],template:function(n,s){n&1&&(e(0,`
    `),v(1,"page-header"),e(2,`
