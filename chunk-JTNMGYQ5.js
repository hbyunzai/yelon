import{a as ee,b as te}from"./chunk-4TH24IY7.js";import{a as y,b as $,c as P,d as U,q,r as J,s as Q,y as W}from"./chunk-LGZLE6KP.js";import{F as j,H as G,x as A,y as O}from"./chunk-YVNN56XS.js";import{Ag as B,Db as e,Eb as s,Ja as r,Lb as M,Mb as F,Sa as _,Va as z,Wc as L,Xa as C,Zc as E,_c as V,cb as d,cc as T,db as k,fa as c,fb as D,gb as N,ha as g,hb as i,ib as o,jb as v,nb as h,nd as w,pd as R,qa as u,qb as f,ra as x,sb as m,sh as H,uh as K,vb as b,vh as Y,wa as S,xa as I,xh as Z,zg as X}from"./chunk-5G6CWZQB.js";var re=()=>["ant-menu-item-selected"];function ae(n,p){n&1&&(e(0,`
          ...
          `),i(1,"li",2),f("click",function(){let a=u(t).$implicit,ie=m(2);return x(ie.to.emit(a.url))}),e(2,`
            `),i(3,"nz-badge",3),e(4,`
              ...
              `),_(11,ae,4,1),o(),e(12,`
          `),o(),e(13,`
        `)}if(n&2){let t=p.$implicit;r(),C("menu-deprecated",t.deprecated),z("routerLink",t.url)("routerLinkActive",F(9,re))("nzTooltipTitle",t.deprecated?"Deprecated in "+t.deprecated:null),r(2),z("nzDot",t.hot),r(3),s(t.title),r(3),s(t.subtitle),r(2),d(t.lib?11:-1)}}function me(n,p){if(n&1&&(e(0,`
    `),i(1,"li",1),e(2,`
      `),i(3,"ul"),e(4,`
...
`)),l&2&&(r(2),N(a.menus))},dependencies:[E,V,G,j,O,A,U,P,Z,K,H,Y],encapsulation:2,changeDetection:0})}}return n})();function ce(n,p){if(n&1){let t=h();e(0,`
    `),i(1,"div",4),e(2,`
      `),i(3,"nz-affix"),e(4,`
...
`)}if(n&2){let t=m();r(3),C("drawer-open",t.opened)}}var Ge=(()=>{class n{constructor(){this.meta=c(y),this.mobileSrv=c($),this.cdr=c(T),this.destroy$=c(S),this.opened=!1}ngOnInit(){this.mobileSrv.change.pipe(w(this.destroy$)).subscribe(t=>{this.isMobile=t,this.cdr.detectChanges()})}to(){this.opened=!1}static{this.\u0275fac=function(l){return new(l||n)}}static{this.\u0275cmp=g({type:n,selectors:[["app-content"]],hostVars:2,hostBindings:function(l,a){l&2&&C("main-wrapper",!0)},standalone:!0,features:[M],decls:16,vars:5,consts:[["nz-row",""],["nz-col","","nzXs","24","nzSm","24","nzMd","18","nzLg","18","nzXl","19","nzXXl","20"],[1,"main-container"],["small",""],["nz-col","","nzXs","24","nzSm","24","nzMd","6","nzLg","6","nzXl","5","nzXXl","4",1,"main-menu"],["main-menu","",1,"main-menu-inner",3,"to"],[1,"prev-next-nav"],[1,"prev-page",3,"routerLink"],["nz-icon","","nzType","left",1,"footer-nav-icon-before"],[1,"chinese"],[1,"next-page",3,"routerLink"],["nz-icon","","nzType","right",1,"footer-nav-icon-after"],[1,"drawer-wrapper"],[1,"drawer","drawer-left"],[1,"drawer-mask",3,"click"],[1,"drawer-content-wrapper"],[1,"drawer-content"],[3,"to"],[1,"drawer-button",3,"click"],["nz-icon","","nzType","menu-unfold"]],template:function(l,a){l&1&&(i(0,"div",0),e(1,`
  ...
  `),o(),e(13,`
`),o(),e(14,`
`),_(15,ue,20,2)),l&2&&(r(2),d(a.isMobile?-1:2),r(3),C("pages-container",a.meta.isPages),r(5),d(a.meta.next||a.meta.prev?10:-1),r(5),d(a.isMobile?15:-1))},dependencies:[L,E,W,te,ee,B,X,ne,Q,J,q],encapsulation:2,changeDetection:0})}}return n})();export{Ge as a};
