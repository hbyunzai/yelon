...
> Install [ng-yunzai snippets](https://marketplace.visualstudio.com/items?itemName=devcui.ng-yunzai-vscode) plugin in VSCode for intellisense these class names.
