...
ng-yunzai 除了提供主题方案以外，还包含一套类似 Bootstrap 的工具集，并且严格遵守 Antd 的设计价值观，对于熟悉 Bootstrap 的人来说会非常友好，因为所有命名方式都尽可能与 Bootstrap 相同。同时，我们为 VSCode 写的 [ng-yunzai插件](https://marketplace.visualstudio.com/items?itemName=yunzai-bot.ng-yunzai-vscode) 会自动为你提供这套CSS工具集的智能提醒。
