    ...
    children: [
      {
        ...
        children: [
          ...
          { text: 'v3' },
          {
            ...
            externalLink: '//ng.yunzainfo/blank',
            target: '_blank'
          },
          {
            text: 'externalLink-top',
            externalLink: '//ng.yunzainfo/top',
            target: '_top'
          }
        ]
      },
...
describe('theme: layout-default-nav', () => {
  ...
  function createModule(): void {
    TestBed.configureTestingModule({
      imports: [NoopAnimationsModule, RouterModule.forRoot([]), YunzaiThemeModule, LayoutDefaultModule],
    ...
    describe('[default]', () => {
      ...
      describe('should be navigate external link', () => {
        ...
        it('with target is _top', () => {
          ...
          itemEl!.click();
          expect(win.location.href).toBe(`//ng.yunzainfo/top`);
        });
      });
    ...
    describe('#icon', () => {
      ...
      describe('with icon', () => {
        ...
        it('when is string and http prefix', () => {
          updateIcon('http://ng.yunzainfo/1.jpg');
  ...
  describe('should be recursive path', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RouterModule.forRoot([]), YunzaiThemeModule, LayoutDefaultModule],
        providers: [
          provideRouter([
