...
import {
    ...
    deepCopy,
    log,
    YunzaiMenuAttribute, useLocalStorageCurrent, useLocalStorageUser, useLocalStorageDefaultRoute
} from '@yelon/util';
...
export class YunzaiStartupService {
    ...
    systemInit(): void {
        ...
        if (currentMenu) {
            ...
            this.aclService.attachRole(yunzaiUser?.roles.map((role: NzSafeAny) => {
