...
import { YunzaiConfigService, YunzaiExceptionType } from '@yelon/util/config';
...
export class ExceptionComponent {
  ...
  hasCon = signal(false);
  private typeDict!: NonNullable<YunzaiExceptionType['typeDict']>;
  typeItem = signal<NonNullable<YunzaiExceptionType['typeDict']>[ExceptionType] | null>(null);
