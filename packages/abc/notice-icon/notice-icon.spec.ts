...
describe('abc: notice-icon', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [NoopAnimationsModule, NoticeIconModule, HttpClientTestingModule, YelonLocaleModule],
  ...
  it('#i18n', done => {
    ...
    setTimeout(() => {
      ...
      const srv = TestBed.inject<YelonLocaleService>(YelonLocaleService) as YelonLocaleService;
      srv.setLocale(en_US);
      fixture.detectChanges();
