export interface YunzaiAuthConfig {
   ...
   *
   * @deprecated Will be removed in 15.x, Pls used [ALLOW_ANONYMOUS](https://github.com/hbyunzai/yelon/blob/master/packages/auth/src/token.ts) `HttpContext` instead
   */
