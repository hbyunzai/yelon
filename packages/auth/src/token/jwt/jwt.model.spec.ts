...
describe('auth: jwt.model', () => {
  ...
  beforeEach(() => {
    // from: https://jwt.io/
    model.token = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxIiwibmFtZSI6ImRldmN1aSIsImFkbWluIjp0cnVlLCJleHAiOjQ2NzA0MDk2MDB9.shHyoX0bx_ArosYG28D2iwuKyIBtG-lq1yEMvF8Y7tE`;
  });
  const payloadDATA = {
    sub: '1',
    name: 'devcui',
