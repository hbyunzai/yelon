...
export class CacheGettingStartedSimpleComponent implements OnDestroy {
  ...
  ngOnDestroy(): void {
    if (this.notify$) this.notify$.unsubscribe();
        ...
        `),s(),t(8,`
      `),s()()()),n&2&&(p("codes",i.codes)("item",i.item),d(),p("nzGutter",16),d(3),p("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[G,$,re,M,D,w],encapsulation:2});let a=o;return a})();var ae=(()=>{let o=class o{get newValue(){return+new Date}constructor(e,n){this.srv=e,this.msg=n,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(n){return new(n||o)(h(y),h(T))},o.\u0275cmp=m({type:o,selectors:[["cache-interceptor-simple"]],standalone:!0,features:[u],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(n,i){n&1&&(t(0,`
    `),r(1,"p"),t(2),C(3,"json"),s(),t(4,`
    `),r(5,"div",0),t(6,`
      Basic:
      `),r(7,"button",1),l("click",function(){return i.srv.set(i.key,i.newValue)}),t(8,"Set"),s(),t(9,`
...
export class CacheInterceptorSimpleComponent implements OnDestroy {
  ...
  ngOnDestroy(): void {
    if (this.notify$) this.notify$.unsubscribe();
        ...
        `),s(),t(8,`
      `),s()()()),n&2&&(p("codes",i.codes)("item",i.item),d(),p("nzGutter",16),d(3),p("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[G,$,ae,M,D,w],encapsulation:2});let a=o;return a})();var de=(()=>{let o=class o{get newValue(){return+new Date}constructor(e,n){this.srv=e,this.msg=n,this.key="demo"}getByHttp(){this.srv.get("https://randomuser.me/api/?results=1").subscribe(e=>{this.value=e})}registerNotify(){this.notify$&&this.notify$.unsubscribe(),this.notify$=this.srv.notify(this.key).subscribe(e=>{if(e==null){this.msg.success("register success");return}this.msg.warning(`"${this.key}" new status: ${e.type}`)})}unRegisterNotify(){this.srv.cancelNotify(this.key)}ngOnDestroy(){this.notify$&&this.notify$.unsubscribe()}};o.\u0275fac=function(n){return new(n||o)(h(y),h(T))},o.\u0275cmp=m({type:o,selectors:[["cache-service-simple"]],standalone:!0,features:[u],decls:35,vars:3,consts:[[1,"pt-sm"],["nz-button","",3,"click"]],template:function(n,i){n&1&&(t(0,`
    `),r(1,"p"),t(2),C(3,"json"),s(),t(4,`
    `),r(5,"div",0),t(6,`
      Basic:
      `),r(7,"button",1),l("click",function(){return i.srv.set(i.key,i.newValue)}),t(8,"Set"),s(),t(9,`
...
export class CacheServiceSimpleComponent implements OnDestroy {
  ...
  ngOnDestroy(): void {
    if (this.notify$) this.notify$.unsubscribe();
        ...
        `),s(),t(8,`
      `),s()()()),n&2&&(p("codes",i.codes)("item",i.item),d(),p("nzGutter",16),d(3),p("item",i.codes[0]),v("id",i.codes[0].id))},dependencies:[G,$,de,M,D,w],encapsulation:2});let a=o;return a})();var ht=[{path:"",component:Z,children:[{path:"",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started",redirectTo:"getting-started/zh",pathMatch:"full"},{path:"getting-started/:lang",component:ce},{path:"interceptor",redirectTo:"interceptor/zh",pathMatch:"full"},{path:"interceptor/:lang",component:le},{path:"service",redirectTo:"service/zh",pathMatch:"full"},{path:"service/:lang",component:me}]}];export{ht as routes};
