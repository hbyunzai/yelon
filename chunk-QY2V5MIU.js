import{a as te,b as ne}from"./chunk-FFG26ZQU.js";import{B as ee,a as k,b as A,c as U,d as j,s as J,t as Q,u as W}from"./chunk-SCQUIVD4.js";import{F as G,H,x as O,y as P}from"./chunk-NVF533QB.js";import{$c as R,Eb as e,Fb as u,Ja as a,Mb as E,Nb as L,Oa as M,Pa as T,Ua as _,Wa as h,Xc as V,Ya as v,_c as w,ba as F,da as S,db as s,eb as D,gb as N,ha as x,hb as b,ia as f,ib as i,jb as o,kb as z,kg as B,lg as $,ob as g,od as y,qd as X,rb as C,rh as K,tb as c,th as Y,uh as Z,va as d,wb as I,wh as q}from"./chunk-ZKKUKXOF.js";function ae(n,l){n&1&&(e(0,`
          ...
          `),i(1,"li",2),C("click",function(){let p=x(t).$implicit,oe=c(2);return f(oe.to.emit(p.url))}),e(2,`
            `),i(3,"nz-badge",3),e(4,`
              ...
              `),_(11,ae,4,1),o(),e(12,`
          `),o(),e(13,`
        `)}if(n&2){let t=l.$implicit;a(),v("menu-deprecated",t.deprecated),h("routerLink",t.url)("routerLinkActive",L(9,le))("nzTooltipTitle",t.deprecated?"Deprecated in "+t.deprecated:null),a(2),h("nzDot",t.hot),a(3),u(t.title),a(3),u(t.subtitle),a(2),s(11,t.lib?11:-1)}}function ce(n,l){if(n&1&&(e(0,`
    `),i(1,"li",1),e(2,`
      `),i(3,"ul"),e(4,`
        `),N(5,me,14,10,null,null,D),o(),e(7,`
    `),o(),e(8,`
  `)),n&2){let t=l.$implicit;a(),h("nzTitle",t.title),a(4),b(t.list)}}var ie=(()=>{let l=class l{constructor(){this.meta=d(k),this.i18n=d(X),this.cdr=d(M),this.destroy$=d(T),this.count=0,this.to=new F}get menus(){return this.meta.menus}ngOnInit(){this.i18n.change.pipe(y(this.destroy$)).subscribe(()=>this.cdr.markForCheck()),this.count=this.meta.menus?.reduce((m,r)=>m+=r.list.length,0)}};l.\u0275fac=function(r){return new(r||l)},l.\u0275cmp=S({type:l,selectors:[["main-menu"],["","main-menu",""]],outputs:{to:"to"},standalone:!0,features:[E],decls:5,vars:0,consts:[["nz-menu","","nzMode","inline",1,"aside-container"],["nz-menu-group","","nzOpen","",3,"nzTitle"],["nz-menu-item","","nz-tooltip","",2,"padding-left","54px",3,"routerLink","routerLinkActive","nzTooltipTitle","click"],[3,"nzDot"],[1,"name"],[1,"chinese"],["title","Full Library",1,"ml-sm",3,"nzColor"]],template:function(r,p){r&1&&(i(0,"ul",0),e(1,`
  `),N(2,ce,9,1,null,null,D),o(),e(4,`
`)),r&2&&(a(2),b(p.menus))},dependencies:[w,R,H,G,P,O,j,U,q,Y,K,Z],encapsulation:2,changeDetection:0});let n=l;return n})();function pe(n,l){if(n&1){let t=g();e(0,`
    `),i(1,"div",4),e(2,`
      `),i(3,"nz-affix"),e(4,`
...
`)}if(n&2){let t=c();a(3),v("drawer-open",t.opened)}}var He=(()=>{let l=class l{constructor(){this.meta=d(k),this.mobileSrv=d(A),this.cdr=d(M),this.destroy$=d(T),this.opened=!1}ngOnInit(){this.mobileSrv.change.pipe(y(this.destroy$)).subscribe(m=>{this.isMobile=m,this.cdr.detectChanges()})}to(){this.opened=!1}};l.\u0275fac=function(r){return new(r||l)},l.\u0275cmp=S({type:l,selectors:[["app-content"]],hostVars:2,hostBindings:function(r,p){r&2&&v("main-wrapper",!0)},standalone:!0,features:[E],decls:16,vars:5,consts:[["nz-row",""],["nz-col","","nzXs","24","nzSm","24","nzMd","18","nzLg","18","nzXl","19","nzXXl","20"],[1,"main-container"],["small",""],["nz-col","","nzXs","24","nzSm","24","nzMd","6","nzLg","6","nzXl","5","nzXXl","4",1,"main-menu"],["main-menu","",1,"main-menu-inner",3,"to"],[1,"prev-next-nav"],[1,"prev-page",3,"routerLink"],["nz-icon","","nzType","left",1,"footer-nav-icon-before"],[1,"chinese"],[1,"next-page",3,"routerLink"],["nz-icon","","nzType","right",1,"footer-nav-icon-after"],[1,"drawer-wrapper"],[1,"drawer","drawer-left"],[1,"drawer-mask",3,"click"],[1,"drawer-content-wrapper"],[1,"drawer-content"],[3,"to"],[1,"drawer-button",3,"click"],["nz-icon","","nzType","menu-unfold"]],template:function(r,p){r&1&&(i(0,"div",0),e(1,`
  ...
  `),o(),e(13,`
`),o(),e(14,`
`),_(15,xe,20,2)),r&2&&(a(2),s(2,p.isMobile?-1:2),a(3),v("pages-container",p.meta.isPages),a(5),s(10,p.meta.next||p.meta.prev?10:-1),a(5),s(15,p.isMobile?15:-1))},dependencies:[V,w,ee,ne,te,$,B,ie,W,Q,J],encapsulation:2,changeDetection:0});let n=l;return n})();export{He as a};
