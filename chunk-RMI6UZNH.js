import{Ia as i,Mb as e,Mc as f,Ob as l,Pg as v,Qa as c,Vg as _,Xg as y,Yg as z,fc as s,gc as u,ha as d,ih as g,lb as a,mb as t,nb as n,tc as C,vb as m,xh as N,yc as S}from"./chunk-5WYQ2NZI.js";var h=class p{modal=d(g);record;input_value=C("");model_value=S("");ok(){this.modal.destroy(`new time: ${+new Date}`)}cancel(){this.modal.destroy()}static \u0275fac=function(o){return new(o||p)};static \u0275cmp=c({type:p,selectors:[["app-demo-dialog-modal"]],inputs:{record:"record",input_value:[1,"input_value"],model_value:[1,"model_value"]},outputs:{model_value:"model_valueChange"},decls:26,vars:9,consts:[[1,"modal-header"],[1,"modal-title"],[1,"modal-footer"],["nz-button","",3,"click","nzType","nzSize"]],template:function(o,r){o&1&&(e(0,`
    `),t(1,"div",0),e(2,`
